pub mod helper {
    ...
    use sensor::measurement::{GroudTruthPackage, EstimationPackage};
    ...
    pub fn calculate_rmse(estimations: &Vec<EstimationPackage>, ground_truths: &Vec<GroudTruthPackage>) -> Vec<f64> {
